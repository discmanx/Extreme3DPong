...
import java.nio.FloatBuffer;
 ...
 public class BottomScrollBar {
     float posX, posY, posZ;

     private float selectedPct;
     ...
     public BottomScrollBar() {
         ...
         final float[] cubePositionData = {
                 ...
                 // Front face
				 -5.8f, 0.8f, 1.0f,   -5.8f, -.9f, 1.0f,   6.0f, .8f, 1.0f,
				 -5.8f, -.9f, 1.0f,   6.0f, -.9f, 1.0f,   6.0f, .8f, 1.0f, };
     ...
     public float getSelectedPct() {
         return selectedPct;
     }

     public void setSelectedPct(float selectedPct) {
