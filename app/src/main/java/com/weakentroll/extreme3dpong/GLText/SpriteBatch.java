package com.weakentroll.extreme3dpong.GLText;

import android.opengl.GLES20;
import android.opengl.Matrix;

import com.weakentroll.extreme3dpong.GLText.programs.Program;

public class SpriteBatch {

	//--Constants--//
	final static int VERTEX_SIZE = 6;                  // Vertex Size (in Components) ie. (X,Y,Z,U,V,W?,M), M is MVP matrix index
	...
	public void drawSprite(float x, float y, float width, float height, TextureRegion region, float[] modelMatrix)  {
        ...
        vertexBuffer[bufferIndex++] = 0.0f;             // Add Z for Vertex 0
        ...
        vertexBuffer[bufferIndex++] = 0.0f;             // Add Z for Vertex 1
        ...
        vertexBuffer[bufferIndex++] = 0.0f;             // Add Z for Vertex 2
        ...
        vertexBuffer[bufferIndex++] = 0.0f;             // Add Z for Vertex 3
